...
export interface ArtifactRequest { format: ArtifactFormat; template_id: string; use_brand_kit: boolean }
export interface ArtifactVersion { id: string; version_number: number; status: ArtifactStatus; file_name?: string | null; mime_type?: string | null; size_bytes?: number | null; page_count?: number | null; preview_count: number; qa: Record<string, unknown>; error?: string | null; citations: Citation[]; created_at: string }
export interface Artifact { id: string; conversation_id: string; message_id?: string | null; title: string; format: ArtifactFormat; template_id: string; use_brand_kit: boolean; status: ArtifactStatus; current_version: number; progress: number; error?: string | null; version?: ArtifactVersion | null; versions: ArtifactVersion[]; created_at: string; updated_at: string }
export interface OrganizationBrandKit { primary_color: string; accent_color: string; heading_font: string; body_font: string; footer_text: string; logo_file_name?: string | null; logo_mime_type?: string | null; has_logo: boolean; can_manage: boolean; available_fonts: string[]; updated_at?: string | null }
